...
SUBMIT_LIGHTWEIGHT_DIAGNOSTICS="${LIGHTWEIGHT_DIAGNOSTICS:-0}"
SUBMIT_LIGHTWEIGHT_PRODUCT_INTERVAL="${LIGHTWEIGHT_PRODUCT_INTERVAL:-0}"
...
if [[ "$SUBMIT_LIGHTWEIGHT_DIAGNOSTICS" == "1" ]]; then
  JOB_SUFFIX="${JOB_SUFFIX}_lightdiagp${SUBMIT_LIGHTWEIGHT_PRODUCT_INTERVAL}"
fi
...
LIGHTWEIGHT_DIAGNOSTICS="\${LIGHTWEIGHT_DIAGNOSTICS:-$SUBMIT_LIGHTWEIGHT_DIAGNOSTICS}"
LIGHTWEIGHT_PRODUCT_INTERVAL="\${LIGHTWEIGHT_PRODUCT_INTERVAL:-$SUBMIT_LIGHTWEIGHT_PRODUCT_INTERVAL}"
...
LIGHTWEIGHT_FLAGS=()
if [[ "\$LIGHTWEIGHT_DIAGNOSTICS" == "1" ]]; then
  LIGHTWEIGHT_FLAGS=(
    --lightweight_diagnostics
    --lightweight_output_dir "\$CHECKPOINT_DIR/lightweight_diagnostics"
    --lightweight_product_interval "\$LIGHTWEIGHT_PRODUCT_INTERVAL"
  )
fi
...
echo "  lightweight_diagnostics=\$LIGHTWEIGHT_DIAGNOSTICS product_interval=\$LIGHTWEIGHT_PRODUCT_INTERVAL"
